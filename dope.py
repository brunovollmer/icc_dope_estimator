...
def load_model(modelname, no_half=False):
...
def dope_image(imagename, model, ckpt, postprocessing='ppi'):
...
def dope_video(video_name, model, ckpt, postprocessing='ppi'):
...
if __name__=="__main__":
    ...
    parser.add_argument('--no_half', action='store_true', help='disable half computation')

    args = parser.parse_args()

    model, ckpt = load_model(args.model, no_half=args.no_half)

    if args.image:
        dope_image(args.image, model, ckpt, postprocessing=args.postprocess)
    else:
        dope_video(args.video, model, ckpt, postprocessing=args.postprocess)
